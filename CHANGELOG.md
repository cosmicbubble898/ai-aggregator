...
- `/start` slash command (`.claude/commands/start.md`) + a refined, project-scoped session-start protocol in `CLAUDE.md` — one-word session resume (read CLAUDE.md + latest session log, then ask before acting).
